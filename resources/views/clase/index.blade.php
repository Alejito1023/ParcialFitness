...
<html lang="en">
  ...
  <body>
    ...
    <a href="{{ route('clases.create')}}" class="btn btn-success">Add</a>
    <table class="table">
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a href="{{ route('clases.edit',['clase'=>$clase->clase_id])}}"
                    class="btn btn-info"> Edit</a>
                <form action="{{ route('clases.destroy', ['clases'=> $clase->clase_id])}}"
